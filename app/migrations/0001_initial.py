# Generated by Django 5.1.1 on 2024-10-01 03:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Cloths', 'Cloths'), ('Electronics', 'Electronics'), ('Home', 'Home'), ('Kitchen', 'Kitchen'), ('Fashion', 'Fashion'), ('Shoes', 'Shoes'), ('Shoes', 'Shoes'), ('Mobiles', 'Mobiles')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.cart')),
                ('userid', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
